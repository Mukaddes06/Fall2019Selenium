...
public class DateTimeUtilities {
    // this class help us some getting date time
    // some manipulation date and time
    /**
    ...
    public static long getTimeDifference(String start, String end, String format){
        ...
        // ChronoUnit coming from enum this help us different between start time and endTime
