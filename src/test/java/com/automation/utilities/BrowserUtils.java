...
public class BrowserUtils {
     ...
     */
    // this method wait for page the loaded then we jus specify how long need to be wait
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ExpectedCondition<Boolean> expectation = driver -> ((JavascriptExecutor) driver).executeScript("return document.readyState").equals("complete");
                                                                                                        // this wait until the document ready
        try {
    ...
    public static String getScreenshot(String name) {
        ...
        String path = "";
        // System.getProperty--> for find current location!
        // test-output--> its a file store test output result
        // we see name with .png
        ...
        try {
            ...
            // FileUtils class comes from java, to work with the files,
            // general file manipulation properties
