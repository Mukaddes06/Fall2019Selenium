 ...
 */
//what fundamental we added PageBase class
public abstract class AbstractPageBase {

    protected WebDriver driver = Driver.getDriver();
    // we added to super class wait variable than all sub class able to use WebDriver wait object
    protected WebDriverWait wait = new WebDriverWait(driver, 15);
    //we add a becuse it show user name(Parent) and under username (child)
...
//where we store the web element of current user name locator =>
// in abstractPageBase ; because every page has that webelement
