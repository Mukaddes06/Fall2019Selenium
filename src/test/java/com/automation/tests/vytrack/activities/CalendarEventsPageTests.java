...
//        Default title should be blank
        // input elementes dont contain a text.Instead text is insinde attribute "value"
        // so we use getAttribute() method to retrieve that value
        ...
        //Default start date should be current date
        // For some reason, end-part of id is always different.That's why we use contains[]partially match id.
        ...
        // h--> am/pm for 12 hour format
        // m--> minute in the format
        // AM or PM marker
        // there have different time zone
