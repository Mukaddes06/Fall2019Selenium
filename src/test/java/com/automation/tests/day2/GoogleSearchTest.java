...
// By.name("q") --> name="q"
        ...
        // use Key.ENTER
        // Keys.ENTER --> perform keyboard click (just the click this keyword on search box
        search.sendKeys("Java", Keys.ENTER);
        //2000-2 seconds
        // 12000-12 seconds
        // Thread.sleep-->is used the pause java program
        Thread.sleep(4000);

        //if see <a> element , it callss link
        // visible text of this link , can be used by selenium to find this element
        WebElement news= driver.findElement(By.linkText("News"));
        news.click(); // to click on the element
        Thread.sleep(4000);

        driver.quit();// just close everything
