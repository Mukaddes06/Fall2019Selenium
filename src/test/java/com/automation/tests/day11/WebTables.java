...
public class WebTables {
    ...
    public void setup() {
        ...
        // These programs operate like any other browser,
        // but do not display any UI. When Selenium tests are run, it executes in the background.
    ...
    public void deleteRowTest() {
        // /.. go to parent than //a[text()='delete'] -->find the delete
    ...
    public void getColumnIndexByName() {
        ...
        for (int i = 0; i < columnNames.size(); i++) {
            ...
            if (actualColumnName.equals(columnName)) {
                index = i + 1;
                break; // break mean no need to continue its stop here
            }
        }
    ...
    public void getSpecificCell(){
        ...
        int row =1;
        int column=1;
        String xpath = "//tabl[1]//tbody//tr[" + row + "]//td[" + column + "]";
        // row ==1 column =1 we wait email name
